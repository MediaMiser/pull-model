...
public class TwitterUser extends AbstractDomain {
    ...
    public boolean equals(final Object object) {
        ...
        if (this == object) {
            ...
            equals = Objects.equals(name, other.name) && Objects.equals(location, other.location) && Objects.equals(
                    createdAt,
                    other.createdAt) && Objects.equals(id, other.id) && Objects.equals(language, other.language)
                    && Objects.equals(followersCount, other.followersCount) && Objects.equals(verified, other.verified)
                    && Objects.equals(timeZone, other.timeZone) && Objects.equals(statusesCount, other.statusesCount)
                    && Objects.equals(isProtected, other.isProtected) && Objects.equals(
                    isGeoEnabled,
                    other.isGeoEnabled) && Objects.equals(isTranslator, other.isTranslator) && Objects.equals(
                    favouritesCount,
                    other.favouritesCount) && Objects.equals(listedCount, other.listedCount) && Objects.equals(
                    url,
                    other.url) && Objects.equals(description, other.description) && Objects.equals(
                    friendsCount,
                    other.friendsCount) && Objects.equals(screenName, other.screenName) && Objects.equals(
                    followers,
                    other.followers) && Objects.equals(friends, other.friends)
                    && Objects.equals(profileSidebarFillColor, other.profileSidebarFillColor) && Objects.equals(
                    profileSidebarBorderColor,
                    other.profileSidebarBorderColor) && Objects.equals(
                    profileBackgroundTile,
                    other.profileBackgroundTile) && Objects.equals(profileImageUrl, other.profileImageUrl)
                    && Objects.equals(profileImageUrlHttps, other.profileImageUrlHttps) && Objects.equals(
                    profileLinkColor,
                    other.profileLinkColor) && Objects.equals(profileBannerUrl, other.profileBannerUrl)
                    && Objects.equals(profileTextColor, other.profileTextColor) && Objects.equals(
                    profileBackgroundImageUrl,
                    other.profileBackgroundImageUrl) && Objects.equals(
                    profileBackgroundImageUrlHttps,
                    other.profileBackgroundImageUrlHttps) && Objects.equals(
                    profileBackgroundColor,
                    other.profileBackgroundColor);
        }
