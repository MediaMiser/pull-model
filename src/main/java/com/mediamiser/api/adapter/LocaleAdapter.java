...
public class LocaleAdapter extends XmlAdapter<String, Locale> {
	...
	protected static final Pattern	PATTERN_BCP47				= Pattern.compile(
																		REGULAR_EXPRESSION_BCP47,
																		Pattern.CASE_INSENSITIVE);
	public static final String		DOCUMENTATION_LOCALE	= "A <a href=\"http://tools.ietf.org/html/bcp47\">BCP 47</a> tag";
	...
	public Locale unmarshal(final String string) throws Exception {
		...
		if (StringUtils.isNotBlank(string)) {
			...
			if (matcher.matches()) {
				...
				throw new ConstraintViolationException("Expected a valid BCP47 language tag, not " + string, violations);
			}
		}
